...
namespace Applied_Accounts.Reports
{
    public partial class Preview_Voucher : Form
    {
        ...
        {
            string _ReportDateFormat = Applied.GetString("DateFormat_Report");
            ...
            MyReportClass.Heading2 = string.Concat("Date :: ", MyReportClass.Vou_Date.ToString(_ReportDateFormat));
            ...
            rpt_Voucher.LocalReport.SetParameters(rpt_Parameter4);
